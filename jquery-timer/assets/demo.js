...
var Example1 = new (function() {
    var $stopwatch, // Stopwatch element on the page
        ...
        init = function() {
            $stopwatch = $('#stopwatch');
            Example1.Timer = $.timer(updateTimer, incrementTime, false);//true for auto start, false for start from 0
        };
...
var Example2 = new (function() {
    var $countdown,
        ...
        init = function() {
            $countdown = $('#countdown');
            Example2.Timer = $.timer(updateTimer, incrementTime, false);//true for auto start, false for start from 0
            $form = $('#example2form');
