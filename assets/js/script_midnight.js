var selectedTimezone = 7; // default +0 you can change to other UTC
var timezones = {
    min: -12,
    max: 14,
...
function populateSelectBox(select) {
    ...
    select.value = 'UTC+7'; // default +0 you can change to other UTC just for display or just hide it from HTML
}
